...
<!--                 <li><label>Book Id:&nbsp;</label>	<input type="text" name="bookid" class="" placeholder="Book Id" required pattern="^\d*$" /></li>
                ...
                <table style="margin-left: 250px;">
                  ...
                  <tr>
                    <td><input type="number" name="book_id1" placeholder="Book ID"></td>
                    <td><input type="number" name="book_id2" placeholder="Book ID"></td>
                  </tr>
                  <tr>
                    <td><input type="text" name="book_name1" placeholder="Book Name"></td>
                    <td><input type="text" name="book_name2" placeholder="Book Name"></td>
                  </tr>
                  <tr>
                    <td><input type="text" name="date_out1" placeholder="Date Out" onfocus="(this.type='date')"></td>
                    <td><input type="text" name="date_out2" placeholder="Date Out" onfocus="(this.type='date')"></td>
                  </tr>
                  <tr>
                    <td><input type="text" name="due_date1" placeholder="Due Date" onfocus="(this.type='date')"></td>
                    <td><input type="text" name="due_date2" placeholder="Due Date" onfocus="(this.type='date')"></td>
                  </tr>
                </table>


    </ul>
          <button type="submit" name="submit" style="margin-left: 380px;">Add</button>
